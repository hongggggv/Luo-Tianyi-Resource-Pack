...
### **注：本资源包由洛天依粉丝创建，与洛天依任何官方无关。所有内容均出于对角色和社区的热爱和尊重。部分文案源自[沙雕翻译包](https://modrinth.com/resourcepack/stupid-mc-translate-chn)和梗体中文。**
# 关于开源
- 本资源包遵循GPL-3.0开源协议，你可以：
- 修改并二次发布，以及在"title.credits": "作者：@B-0712天依號A359"这一行修改为你的名称，但必须在credits.json标上我的名称（B-0712天依號A359）以及开源。
- 你不可以：
- 在任何情况下宣称Tianyicraft是由你制作或归你所有，将修改后且闭源的资源包发布于社交平台。
